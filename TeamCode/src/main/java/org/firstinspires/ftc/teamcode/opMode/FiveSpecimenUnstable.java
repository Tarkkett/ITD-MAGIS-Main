...
public class FiveSpecimenUnstable extends OpModeTemplate {
    ...
    public void init() {
        ...
        trajToHang1st = drive.actionBuilder(new Pose2d(50, -62, Math.toRadians(-270)))
                .splineToConstantHeading(new Vector2d(7, DIST_Y_CHAMBER), Math.toRadians(-270),null, new ProfileAccelConstraint(-25, 55))
                .build();

        trajToHang2nd = drive.actionBuilder(new Pose2d(43, -62, Math.toRadians(-270)))
                .splineToConstantHeading(new Vector2d(5, DIST_Y_CHAMBER), Math.toRadians(-270), null, new ProfileAccelConstraint(-25, 55))
                .build();

        trajToHang3rd = drive.actionBuilder(new Pose2d(43, -62, Math.toRadians(-270)))
                .splineToConstantHeading(new Vector2d(3, DIST_Y_CHAMBER), Math.toRadians(-270), null, new ProfileAccelConstraint(-25, 55))
                .build();

        trajToHang4th = drive.actionBuilder(new Pose2d(43, -62, Math.toRadians(-270)))
                .strafeToConstantHeading(new Vector2d(1, DIST_Y_CHAMBER), null, new ProfileAccelConstraint(-25, 55))
                .build();

        trajToPickup1st = drive.actionBuilder(new Pose2d(7, DIST_Y_CHAMBER, Math.toRadians(-270)))
                .setReversed(true) //Pickup 1
                .splineToConstantHeading(new Vector2d(43, -62), Math.toRadians(-90), null, new ProfileAccelConstraint(-25, 55))
                .build();
        ...
        longTraj = drive.actionBuilder(new Pose2d(DIST_X_CHAMBER, DIST_Y_CHAMBER, Math.toRadians(-270)))
                ...
                .splineToConstantHeading(new Vector2d(50, -51), Math.toRadians(-90), new TranslationalVelConstraint(10), new ProfileAccelConstraint(-20, 7))
                .splineToConstantHeading(new Vector2d(50, -50), Math.toRadians(-270), new TranslationalVelConstraint(10), new ProfileAccelConstraint(-20, 7))

                .strafeToConstantHeading(new Vector2d(50, -15), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-100, 22))
                ...
                .splineToConstantHeading(new Vector2d(58, -51), Math.toRadians(-90), new TranslationalVelConstraint(10), new ProfileAccelConstraint(-20, 7))
                .splineToConstantHeading(new Vector2d(58, -50), Math.toRadians(-270), new TranslationalVelConstraint(10), new ProfileAccelConstraint(-20, 7))

                .strafeToConstantHeading(new Vector2d(58, -15), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-20, 18))

                .splineToConstantHeading(new Vector2d(67, -15), Math.toRadians(-90), new TranslationalVelConstraint(15))
                .strafeToConstantHeading(new Vector2d(67, -50), new TranslationalVelConstraint(50))

                .splineToConstantHeading(new Vector2d(50, -62), Math.toRadians(-90), new TranslationalVelConstraint(23), new ProfileAccelConstraint(-25, 55))
                .build();
