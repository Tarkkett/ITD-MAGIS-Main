...
public class MainAutoBlue extends OpModeTemplate {
    ...
    private final Pose scorePosePreload = new Pose(40.5, 63, Math.toRadians(0));
    private final Pose backFromChamberPose = new Pose(30, 42, Math.toRadians(0));

    private final Pose scorePose1 = new Pose(40.5, 63, Math.toRadians(0));
    private final Pose scorePose2 = new Pose(40.5, 66, Math.toRadians(0));
    private final Pose scorePose3 = new Pose(40.5, 68, Math.toRadians(0));
    private final Pose scorePose4 = new Pose(40.5, 70, Math.toRadians(0));
    ...
    private final Pose pickup3Pose = new Pose(61, 6, Math.toRadians(0));
    private final Pose push3Pose = new Pose(20.5, 6, Math.toRadians(0));

    private final Pose grabPreloadPose = new Pose(7, 26, Math.toRadians(0));
    ...
    public void buildPaths() {
        ...
        grab1 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(scorePose1), new Point(19, 65, Point.CARTESIAN), new Point(grabPreloadPose)))
                .setPathEndTimeoutConstraint(100)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        grab2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(scorePose2), new Point(19, 65, Point.CARTESIAN), new Point(grabPreloadPose)))
                .setPathEndTimeoutConstraint(100)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        grab3 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(scorePose3), new Point(19, 65, Point.CARTESIAN), new Point(grabPreloadPose)))
                .setPathEndTimeoutConstraint(100)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        scorePreload = follower.pathBuilder()
            ...
            ).setPathEndTimeoutConstraint(0.2)
            .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
            .build();

        //! -> 4
        score1 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(grabPreloadPose), new Point(18, 66, Point.CARTESIAN), new Point(scorePose1)))
                .setPathEndTimeoutConstraint(100)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        score2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(grabPreloadPose), new Point(18, 66, Point.CARTESIAN), new Point(scorePose2)))
                .setPathEndTimeoutConstraint(100)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        score3 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(grabPreloadPose), new Point(18, 66, Point.CARTESIAN), new Point(scorePose3)))
                .setPathEndTimeoutConstraint(100)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        score4 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(grabPreloadPose), new Point(26, 63, Point.CARTESIAN), new Point(scorePose4)))
                .setPathEndTimeoutConstraint(100)
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
